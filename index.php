...
<!--Index Form which contain Login Form to Auntenticate Authorized Users-->
<!DOCTYPE html>
<html>
<head>
  <!--Title for this page-->
...
<body >
    ...
    <div class="d-flex justify-content-center h-100" >
      <div class="user_card">
        <div class="d-flex justify-content-center form_container">
          ...
          <!-- Input type which is hidden to update CSRF to fight intruders-->
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="password" placeholder="Enter Password" name="pass" required="" value="<?php if(isset($_COOKIE['password'])){ echo $_COOKIE['password'];} ?>">
          ...
          I don't have an account <a href="createaccount.php" style="text-decoration: none;">Signup</a></c> ||
          Forgot Password <a href="checkemail.php" style="text-decoration: none;">Recover</a></c>
           </div>
          </form>
        </div>
    <br>
